...
export default function SmartPicks() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 sm:px-10 py-14 sm:py-24">
      ...
      {/* CTA moved below the rail — it used to overlap the carousel's arrows. */}
      <div className="mt-10 flex justify-center">
        <Link
          to="/tailored"
          className="btn-press inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#111827] text-white text-sm font-semibold hover:bg-[#16A34A] transition-colors"
        >
          {t("home.picks_cta")}
